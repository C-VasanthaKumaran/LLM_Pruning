...
def main(args):
    ...
    # Load Pruned Model
    pruned_dict = torch.load('/home/vasanth/Downloads/LLM-Pruner-main/prune_log/tinyllama_chat_v-6_prune_log/pytorch_model.bin', map_location='cpu')
...
if __name__ == "__main__":
    ...
    # Model Type&Path
    parser.add_argument('--base_model', type=str, default="TinyLlama/TinyLlama-1.1B-Chat-v0.6", help='base model name')
